# Generated by Django 4.2.19 on 2025-03-22 20:33
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "start_time",
                    models.TimeField(
                        blank=True, null=True, verbose_name="time started"
                    ),
                ),
                (
                    "end_time",
                    models.TimeField(blank=True, null=True, verbose_name="time ended"),
                ),
                ("elapsed_time", models.IntegerField(default=None, null=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                django.db.models.functions.text.Lower("operation_type"),
        ...
        migrations.AddField(
            ...
            name="operation_type",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="timer.operationtype"
            ),
        ),
        migrations.AddField(
            model_name="operationinstance",
            name="surgeon",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="timer.surgeon"
            ),
        ),
    ]
